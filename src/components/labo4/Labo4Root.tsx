...
const Labo4Root = () => {
  ...
  return (
    <div className="container">
      <div className="nav">
        <Link to="colorselect" onClick={() => setSelected(true)}>Color Select</Link>
        <Link to="counterlist" onClick={() => setSelected(true)}>Counter List</Link>
        <Link to="filtering" onClick={() => setSelected(true)}>Filtering</Link>
        <Link to="shoppinglist" onClick={() => setSelected(true)}>Shopping List</Link>
        <Link to="slotmachine" onClick={() => setSelected(true)}>Slot Machine</Link>
        <Link to="tictactoe" onClick={() => setSelected(true)}>Tic Tac Toe</Link>
      </div>
        ...
        {selected ? <div /> :
          <div>
            <fieldset>
              ...
              <Link to="colorselect" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
            <fieldset>
              ...
              <Link to="counterlist" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
            <fieldset>
              ...
              <Link to="filtering" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
            <fieldset>
              ...
              <Link to="shoppinglist" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
            <fieldset>
              ...
              <Link to="slotmachine" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
            <fieldset>
              ...
              <Link to="tictactoe" onClick={() => setSelected(true)}>Go</Link>
            </fieldset>
          </div>
        }
        <Outlet />
